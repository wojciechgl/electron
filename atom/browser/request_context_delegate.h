...
class RequestContextDelegate
    : public base::RefCountedThreadSafe<RequestContextDelegate>,
 ...
 private:
  friend class base::RefCountedThreadSafe<RequestContextDelegate>;
  friend class base::DeleteHelper<RequestContextDelegate>;
